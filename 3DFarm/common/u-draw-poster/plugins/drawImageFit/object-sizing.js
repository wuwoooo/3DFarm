...
export function concreteRect(style, intrinsicSize, specifiedSize) {
    ...
    const xRelativeOrigin = { left: 0, center: 0.5, right: 1 }[((_a = style.intrinsicPosition) === null || _a === void 0 ? void 0 : _a[0]) || 'center'];
    const yRelativeOrigin = { top: 0, center: 0.5, bottom: 1 }[((_b = style.intrinsicPosition) === null || _b === void 0 ? void 0 : _b[1]) || 'center'];
